    ...
    <div className="nova-fade-in max-w-2xl mx-auto px-6 py-14 w-full">
      ...
      <Section title="2. Copyright complaints (DMCA)">
        <p>
          ...
          <a className="text-violet" href={`mailto:${COMPANY.dmcaEmail}`}>{COMPANY.dmcaEmail}</a> including:
        </p>
      ...
      <Section title="Contact">
        <p>
          ...
          <a className="text-violet" href={`mailto:${COMPANY.supportEmail}`}>{COMPANY.supportEmail}</a>.
        </p>
      </Section>
    </div>
  );
