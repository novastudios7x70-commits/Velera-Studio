    ...
    <div className="nova-fade-in max-w-2xl mx-auto px-6 py-14 w-full">
      ...
      <Section title="Your rights (CCPA/CPRA, GDPR)">
        <p>
          ...
          email <a className="text-text underline underline-offset-2" href={`mailto:${COMPANY.privacyEmail}`}>{COMPANY.privacyEmail}</a> —
      ...
      <Section title="Contact">
        <p>
          Questions about this policy: <a className="text-text underline underline-offset-2" href={`mailto:${COMPANY.privacyEmail}`}>{COMPANY.privacyEmail}</a>.
