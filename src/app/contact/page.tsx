...
export default function ContactPage() {
  ...
  return (
    <div className="nova-fade-in max-w-lg mx-auto px-6 py-16 w-full">
      ...
      {!sent ? (
        <>
          <h1 className="nova-display font-semibold mb-1 text-[22px] text-text">Let&apos;s build your content engine</h1>
        ...
        <div className="text-center py-10">
          ...
          <h1 className="nova-display font-semibold mb-2 text-[20px] text-text">Message sent</h1>
