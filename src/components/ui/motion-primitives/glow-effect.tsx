"use client";
// Ported from motion-primitives (github.com/ibelick/motion-primitives),
// MIT licensed — animated conic/radial glow, used behind primary CTAs per
// the "restrained glow on primary CTAs" line in the design tokens.
